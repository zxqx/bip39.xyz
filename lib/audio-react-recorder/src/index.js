...
export default class AudioReactRecorder extends React.Component {
  ...
  static propTypes = {
    ...
    //method calls
    onMicrophoneAccessGranted: PropTypes.func,
  ...
  getStream = (constraints) => {
    ...
    // PATCH: Fix stream record issue on first record by calling this method twice
  ...
  setUpRecording = () => {
    ...
    this.recorder.onaudioprocess = function (e) {
      ...
      if (!self.tested) {
        ...
        // PATCH: Remove this logic as it incorrectly closes stream on Firefox / mobile browsers
  ...
  setupMic = async () => {
    ...
    try {
      ...
      if (this.props.onMicrophoneAccessGranted) {
        this.props.onMicrophoneAccessGranted()
      }

      //TODO: on got stream
    } catch (err) {
      this.props.onMicrophoneAccessRejected()
